...
def register_instructor(request):
    ...
    if request.method == "POST":
        ...
        if user_form.is_valid() and instructor_form.is_valid():
            ...
            try:
                ...
                instructor.total_learners = instructor_form.cleaned_data[
                    "total_learners"
                ]
                instructor.save()
    ...
    context = {"page": page, "user_form": user_form, "instructor_form": instructor_form}
...
def register_learner(request):
    ...
    context = {"user_form": user_form, "learner_form": learner_form, "page": page}
