...
class CourseForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["description"].widget.attrs.update(
            {"class": "form-control description", "placeholder": " Course Description"}
        )
        self.fields["pub_date"].widget.attrs.update(
            {"class": "form-control", "placeholder": " Date Created"}
        )
        ...
        self.fields["instructors"] = forms.ModelMultipleChoiceField(
            ...
            widget=forms.SelectMultiple(
                attrs={"class": "form-control col-sm-10 custom-width"}
            ),
        )
...
class EnrollmentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["mode"].widget.attrs.update(
            {"class": "form-control col-sm-10 custom-width"}
        )
        self.fields["rating"].widget.attrs.update(
            {"class": "form-control", "placeholder": " Rate Course"}
        )
        self.fields["feedback"].widget.attrs.update(
            {"class": "form-control", "placeholder": "Add Feedback (Optional)"}
        )
