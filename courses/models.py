...
class Course(models.Model):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='created_courses', default=None)
...
class Enrollment(models.Model):
    ...
    mode = models.CharField(max_length=10, choices=ENROLLMENT_MODE_CHOICES, default='free')
